...
#### Chromagrams
```{r chromagrams sections and bars, include=FALSE}
sweetie_sec %>%
...
#### Cepstograms
```{r cepstograms sections and bars, include=FALSE}
sweetie_sec %>%
...
### Outlier self-similarity matrices
